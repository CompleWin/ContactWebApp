const Pagination = ({ currentPage, totalPages, onPageChange }) => {
    ...
    if (totalPages <= countPagination) {
        ...
        // Если мы смотрим на первую страницу
        if (currentPage <= Math.floor(countPagination / 2)) {
            startPage = 1;
            endPage = countPagination;
        // Если смотрим на последнюю страницу
        } else if (currentPage + Math.floor(countPagination / 2) >= totalPages) {
            startPage = totalPages - countPagination;
            endPage = totalPages;
        // Количество элементов слева и справа
        } else {
